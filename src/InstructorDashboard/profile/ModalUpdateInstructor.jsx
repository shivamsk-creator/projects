...
const ModalUpdateInstructor = ({
  ...
  useEffect(() => {
    ...
    setDob(instructorData.dob);
    setQualification(instructorData.qualification);
    setDegree(instructorData.degree);
    setExp(instructorData.exp);
    setContact(instructorData.contact);
    setPassword(instructorData.password);
    setProfilePic(instructorData.profilePic);
  }, [instructorData]);
  ...
  const handleSubmit = (e) => {
    ...
    fetch(baseurl + "/api/instructor/" + instructorData._id, {
      method: "PUT",
      body: formData,
    })
...
export default ModalUpdateInstructor;
