    ...
    <>
      <footer className="text-center bg-[var(--secondary-color)] text-white lg:text-left">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="">
              ...
              <p className="my-2 pr-10 text-justify">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum
                inventore rerum, deleniti, similique non vitae quae soluta
                molestias reiciendis earum, minus dolore fugiat temporibus
                incidunt.
              </p>
            ...
            {/* Company section */}
            <div className="">
              <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start text-[var(--theme-color)]">
                Courses
              </h6>
              <p className="mb-4">
        ...
        <div className="bg-neutral-200 p-6 text-center">
          ...
          <a
            className="font-semibold hover:text-[var(--theme-color)] animation"
            href="#"
          >
