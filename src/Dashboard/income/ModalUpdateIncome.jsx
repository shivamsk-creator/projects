...
const ModalUpdateIncome = ({ open, handleOpen, getIncomeList, item }) => {
  ...
  useEffect(() => {
    setIncome_head(item.income_head);
    setName(item.name);
  ...
  const onSubmitClick = (e) => {
    ...
    fetch(baseurl + "/api/income/" + item._id, {
      method: "PUT",
      body: formData,
    })
      .then((res) => {
...
export default ModalUpdateIncome;
